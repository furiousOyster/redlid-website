      ...
      <Container fluid id="NavContainer">
        ...
        <div className="HowItWorks">
          <Row>
            ...
            <Col xs={12} lg={6} className="stronger">
              <p>
          ...
          <row>
            ...
            <p>
              These are some of the benefits of why Red Lid Garden Bins &amp;
              Bags may work for you
            </p>

            <ul>
              <li>
                We are in every suburb every week on the{' '}
                <strong>SAME DAY</strong> (Hamilton only)
              </li>
            ...
            <p>
              Garden Bins are collected from the kerbside on your collection
              day.  Please have the Bin on the kerb by 7am.  We service each
              suburb on the same day each week.  If for some reason you cannot
              get your Garden Bin to the kerb you can arrange with us to do so
            ...
            <p>
              We are proud to be rated the Number 1 Green Waste Collectors in
              the Waikato.
            </p>
            ...
            <p>
              ...
              was changed to Red Lid Garden Bins &amp; Bags Ltd.&nbsp; We
              started out with one tandem trailer which was very hard work in
              the early days.&nbsp; But through hard work and a commitment to
              providing the best customer service, we are now proud of our fleet
              of 7 purpose built compactor trucks.
            </p>
            ...
            <p>
              ...
              service.&nbsp; We have a team that believes in our Vision and we
              are proud of what we achieve every day.
            </p>

            <p>
              We provide more Collection Frequency options than any other
              company in the Waikato.&nbsp; “Good as Gold”&nbsp; “Not a problem”
              is all part of our very prompt and reliable service. We pride
              ourselves on delivering the best service in the Waikato.
            </p>
            ...
            <p>
              ...
              reduces the estimated 40% of Greenwaste that goes to landfills
              each year.
            </p>
            ...
            <p>
              ...
              provide skips but not just for Greenwaste. We also provide skips
              for General waste and Hard fill. At this stage we are only
              providing skips in Hamilton and Cambridge.
            </p>
